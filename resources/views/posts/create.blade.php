@extends('layouts.app')
@section('title', 'Tulis Karya - CoretanPublik')
        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                ...
                @elseif(session('success'))
                    <div
                        class="alert alert-success rounded-3 mb-4 border-0 bg-green-50 text-green-700 d-flex align-items-center">
                ...
                <div class="card border-0 shadow-sm rounded-4 overflow-hidden bg-white/90 backdrop-blur">
                    <div class="card-header bg-transparent border-bottom-0 pt-4 pb-0 px-md-5">
                        <div class="d-flex align-items-center gap-3 mb-2">
                            ...
                            <div>
                                <h2 class="fw-bold text-slate-800 mb-0">Tulis Karya Baru</h2>
                                <p class="text-slate-500 mb-0">Bagikan ide, cerita, atau pandanganmu kepada dunia.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body p-md-5 pt-4">
                        <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="border-2 border-dashed border-slate-300 rounded-4 p-5 text-center bg-slate-50 hover:bg-slate-100 transition duration-200 cursor-pointer relative"
                                    id="drop-zone"
                                    ...
                                    <span class="fw-medium text-slate-700 d-block mb-1">Klik untuk mengunggah gambar</span>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text"
                                    ...
                                    id="title" name="title" placeholder="Masukkan judul yang menarik..." required>
                            </div>

                            <!-- Category
                            <div class="mb-4">
                                <label for="category" class="form-label fw-bold text-slate-700 tracking-wide small text-uppercase">Kategori <span class="text-danger">*</span></label>
                                <select class="form-select bg-slate-50 border-slate-200 shadow-none rounded-3 py-3 px-4 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition cursor-pointer" id="category" name="category" required>
                                    <option value="" selected disabled>Pilih kategori tulisanmu</option>
                            ...
                            <div class="mb-5">
                                ...
                                <textarea
                                    ...
                                    placeholder="Mulai menulis kisahmu di sini..." required
                                    style="resize: vertical; font-size: 1.05rem; line-height: 1.7;"></textarea>
                            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Simple preview logic for image upload if needed
        fileInput.addEventListener('change', function () {
            if (this.files && this.files[0]) {
                ...
                reader.onload = function (e) {
                    ...
                    // Hide contents inside drop zone visually but keep them functional
                    Array.from(dropZone.children).forEach(child => {
                        if (child !== fileInput) child.style.opacity = '0';
                    });
                }
